...
public class RecipeController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<RecipeResponse> updateRecipeById(@PathVariable @Positive Long id, @RequestBody @Valid RecipeRequest request) {
        RecipeResponse response = recipeService.updateById(id, request);
        return ResponseEntity.ok(response);
    }
}
